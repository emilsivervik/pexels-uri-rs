...
const PEXEL_POPULAR_PATH: &str = "popular";
...
impl Popular {
    ...
    /// Create URI from inputed vales from the [`PopularBuilder`].
    pub fn create_uri(&self) -> crate::BuilderResult {
        let uri = format!(
            "{}://{}/{}/{}",
            PEXEL_SCHEME, PEXEL_HOST, PEXEL_VIDEO_PATH, PEXEL_POPULAR_PATH
        );
...
#[cfg(test)]
mod tests {
    use crate::videos::popular::PopularBuilder;
